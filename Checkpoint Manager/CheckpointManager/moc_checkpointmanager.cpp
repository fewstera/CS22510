...
struct qt_meta_stringdata_CheckpointManager_t {
    QByteArrayData data[6];
    char stringdata[90];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_CheckpointManager_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_CheckpointManager_t qt_meta_stringdata_CheckpointManager = {
    {
...
QT_MOC_LITERAL(5, 75, 13)
    ...
    "CheckpointManager\0checkpointChanged\0"
    "\0entrantChanged\0entrantExcludedChanged\0"
    "submitPressed\0"
};
...
const QMetaObject CheckpointManager::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_CheckpointManager.data,
      qt_meta_data_CheckpointManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CheckpointManager.stringdata))
