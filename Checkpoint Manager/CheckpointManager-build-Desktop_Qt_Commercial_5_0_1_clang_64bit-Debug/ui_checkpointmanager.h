...
public:
    ...
    void setupUi(QMainWindow *CheckpointManager)
    {
        ...
        CheckpointManager->resize(295, 325);
        ...
        inptSubmit->setObjectName(QStringLiteral("inptSubmit"));
    ...
    void retranslateUi(QMainWindow *CheckpointManager)
    {
        ...
        inptSubmit->setText(QApplication::translate("CheckpointManager", "Submit", 0));
