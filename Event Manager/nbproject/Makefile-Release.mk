...
OBJECTFILES= \
	${OBJECTDIR}/UI.o \
	${OBJECTDIR}/entrants.o \
	${OBJECTDIR}/courses.o \
	${OBJECTDIR}/checkpoints.o \
	${OBJECTDIR}/nodes.o \
	${OBJECTDIR}/main.o \
	${OBJECTDIR}/event.o \
	${OBJECTDIR}/tracks.o
...
${OBJECTDIR}/entrants.o: entrants.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/entrants.o entrants.c

${OBJECTDIR}/courses.o: courses.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/courses.o courses.c

${OBJECTDIR}/checkpoints.o: checkpoints.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/checkpoints.o checkpoints.c
